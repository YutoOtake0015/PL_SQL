          ...
          FOR i IN 1 .. v_test_tbl_01.COUNT LOOP
            ...
            FOR rec IN (SELECT *
                ...
                AND rec.ed_date BETWEEN v_test_tbl_01(i).st_date AND v_test_tbl_01(i).ed_date THEN
                    ...
                    VALUES (
                        v_test_tbl_01(i).tuban,
                        v_test_tbl_01(i).no,
                        v_test_tbl_01(i).kbn,
                        v_test_tbl_01(i).st_date,
                        rec.ed_date
                    );
            ...
            -- 区分30のレコードを削除
            DELETE TEST_TBL_01
            WHERE no = v_test_tbl_01(i).no AND
                  kbn = v_test_tbl_01(i).kbn AND
                  st_date = v_test_tbl_01(i).st_date AND
                  ed_date = v_test_tbl_01(i).ed_date;
